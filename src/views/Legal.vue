  ...
  <div id="legal">
    <transition name="slide-fade" v-on:leave="leave">
      <Page2Wrapper v-if="isMounted">
        ...
        <p>
          <strong>Propriétaire</strong> : Aymeric Dominique – – 166 bd Voltaire,
          75011, Paris, France
          <br />
        ...
        <p>
          ...
          décidée par Aymeric Dominique, qui s’efforcera alors de communiquer
        ...
        <p>
          Aymeric Dominique est propriétaire des droits de propriété
        ...
        <p>
          ...
          préalable de : Aymeric Dominique.
        </p>
        <p>
        ...
        <p>
          Aymeric Dominique ne pourra être tenue responsable des dommages
          directs et indirects causés au matériel de l’utilisateur, lors de
          l’accès au site https://encadrement-loyers.fr/, et résultant soit de
        ...
        <p>
          ...
          l’espace contact) sont à la disposition des utilisateurs. Aymeric
          Dominique se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, Aymeric
          Dominique se réserve également la possibilité de mettre en cause la
